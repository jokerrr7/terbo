...
local Text = "• أهلاً [المطور الاساسي](tg://user?id="..SUDO_USER..") \n• شكراً لأستخدام سورس تربو \n• أرسل /start\n• لأظهار الاوامر المطور  المجهزه بالكيبورد\n\n."
https.request(Api_Token..'/sendMessage?chat_id='..SUDO_USER..'&text='..URL.escape(Text)..'&parse_mode=Terbodown')
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/dark765/terbo/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURC')
	download_file('https://raw.githubusercontent.com/dark765/terbo/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE')
	download_file('https://raw.githubusercontent.com/dark765/terbo/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE BLA')
	download_file('https://raw.githubusercontent.com/dark765/terbo/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/dark765/terbo/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/dark765/terbo/main/plugins/games.lua','./plugins/games.lua')
