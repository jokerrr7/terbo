...
return '♡ اصدار سورس bebo : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'♡ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس المطور يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
if Terbo == 'welcome on' or Terbo == 'تفعيل المطور' then
if redis:get(terbo..'welc'..msg.chat_id_) == 'on' then
