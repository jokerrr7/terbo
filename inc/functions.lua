...
if redis:get(terbo..'group:add'..msg.chat_id_) then  return '♡ **المجموعة تم تفعيلها مُسبقاً . ' end
...
if cmd == "dn_sudo" then
if not redis:sismember(terbo..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'♡ **العضو » '..USERNAME..' \n♡ ** الايدي » (`'..UserID..'`)\n♡ **انه بالتأكيد ليس مطور \n') end
redis:srem(terbo..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المطور \n',17,USERCAR) 
end
...
.."\n♡ التعديل «» "..(redis:get(terbo..'lock_edit'..msg.chat_id_) or 'false')
.."\n♡ الروابط «» "..(redis:get(terbo..'lock_link'..msg.chat_id_) or 'false')
.."\n♡ التاك «» "..(redis:get(terbo..'lock_tag'..msg.chat_id_) or 'false')
.."\n♡ المعرفات «» "..(redis:get(terbo..'lock_username'..msg.chat_id_) or 'false')
.."\n♡ التكرار «» "..(redis:get(terbo..'lock_flood'..msg.chat_id_) or 'false')
.."\n♡ الكلايش «» "..(redis:get(terbo..'lock_spam'..msg.chat_id_) or 'false')
.."\n♡ الويب «» "..(redis:get(terbo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n♡ الماركدوان «» "..(redis:get(terbo..'lock_terbodown'..msg.chat_id_) or 'false')
.."\n♡ بالطرد البوتات «» "..(redis:get(terbo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n♡ البوتات «» "..(redis:get(terbo..'lock_bots'..msg.chat_id_) or 'false')
.."\n♡ عدد التكرار «» "..(redis:get(terbo..'num_msg_terbo'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡`اعدادات الوسائط :`\n"
.."\n*♡ *المتحركه «» "..(redis:get(terbo..'mute_gif'..msg.chat_id_) or 'false')
.."\n♡ الدردشه «» "..(redis:get(terbo..'mute_text'..msg.chat_id_) or 'false')
.."\n♡ الانلاين «» "..(redis:get(terbo..'mute_inline'..msg.chat_id_) or 'false')
.."\n♡ الالعاب «» "..(redis:get(terbo..'mute_game'..msg.chat_id_) or 'false')
.."\n♡ الصور «» "..(redis:get(terbo..'mute_photo'..msg.chat_id_) or 'false')
.."\n♡ الفيديو «» "..(redis:get(terbo..'mute_video'..msg.chat_id_) or 'false')
.."\n♡ البصمات «» "..(redis:get(terbo..'mute_audio'..msg.chat_id_) or 'false')
.."\n♡ الصوت «» "..(redis:get(terbo.'mute_voice'..msg.chat_id_) or 'false')
.."\n♡ الملصقات «» "..(redis:get(terbo..'mute_sticker'..msg.chat_id_) or 'false')
.."\n♡ الجهات «» "..(redis:get(terbo..'mute_contact'..msg.chat_id_) or 'false')
.."\n♡ التوجيه «» "..(redis:get(terbo..'mute_forward'..msg.chat_id_) or 'false')
.."\n♡ الموقع «» "..(redis:get(terbo..'mute_location'..msg.chat_id_) or 'false')
.."\n♡ الملفات «» "..(redis:get(terbo..'mute_document'..msg.chat_id_) or 'false')
.."\n♡ الاشعارات «» "..(redis:get(terbo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n♡ الكيبورد «» "..(redis:get(terbo..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*`اعدادات اخرى : `"
.."\n\n*♡*الترحيب «» "..welcomex
.."\n*♡*الردود «» "..replayx
...
.."\n*♡*الويب «» "..(redis:get(terbo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*♡*الماركدوان «» "..(redis:get(terbo..'lock_terbodown'..msg.chat_id_) or 'false')
.."\n*♡*البوتات بالطرد «» "..(redis:get(terbo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*♡*البوتات «» "..(redis:get(terbo..'lock_bots'..msg.chat_id_) or 'false')
.."\n*♡*عدد التكرار «» "..(redis:get(terbo..'num_msg_terbo'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*اعدادات التقـييد :\n"
.."\n*♡*التقييد بالتوجيه «» "..(redis:get(terbo..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالصور «» "..(redis:get(terbo..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالروابط «» "..(redis:get(terbo..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالمتحركه «» "..(redis:get(terbo..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد الفيديو «» "..(redis:get(terbo..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
